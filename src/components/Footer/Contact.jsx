    ...
    <section className='bg-gray-100 py-12' id='contact'>
      <div className='container mx-auto p-6 bg-white rounded-lg shadow-lg'>
        ...
        <div className="flex flex-col items-center text-center mb-12">
          <h2 className='py-4 relative font-bold text-gray-800 text-4xl mb-4'>
            Contact Us
          </h2>
        ...
        <div className="flex flex-col lg:gap-x-8 lg:flex-row">
          ...
          <form className='space-y-8 w-full max-w-[780px]' action="">
            <div className='flex gap-8'>
              <input 
                className='bg-gray-100 border border-gray-300 text-gray-800 h-15 py-3 px-6 w-full text-base rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-300 focus:border-transparent shadow-sm' 
                type="text" 
            ...
            <input 
              type="text" 
              className='bg-gray-100 border border-gray-300 text-gray-800 h-15 py-3 px-6 w-full text-base rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-300 focus:border-transparent shadow-sm' placeholder='Subject' 
            />
            <textarea
              className='bg-gray-100 border border-gray-300 text-gray-800 h-15 py-3 px-6 w-full text-base rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-300 focus:border-transparent shadow-sm'
