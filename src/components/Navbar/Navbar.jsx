...
const Navbar = () => {
  ...
  return (
    <div className="sticky z-50 top-0 w-full bg-gray-900 shadow-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
        ...
        <div className="inline-flex items-center space-x-2">
          ...
          <NavLink to={"/"}>
            <span className="font-bold text-white">DTU PIXELS</span>
          </NavLink>
        </div>
        ...
        <div className="hidden space-x-2 lg:block">
          {user ? (
            <div className="relative" ref={dropdownRef}>
              ...
              {dropdownOpen && (
                <div className="absolute z-50 right-0 mt-2 w-48 bg-gray-800 rounded-md shadow-xl py-1"> {/* Changed background */}
                  <div className="px-4 py-3 border-gray-700 flex flex-col items-center justify-center"> {/* Changed border color */}
                    <h3 className="text-md font-bold text-white mb-1"> {/* Changed text color */}
                      {user.displayName}
                    </h3>
                    {isAdmin && (
                      <span className="text-xs font-semibold text-orange-500"> {/* Changed color */}
                        Admin
                      </span>
                    )}
                  </div>
                  <CopyUID className="border-t border-gray-700 my-1" /> {/* Changed border color */}
        ...
        <div className="lg:hidden">
          <Menu onClick={toggleSidebar} className="h-6 w-6 cursor-pointer text-white" />
        </div>
