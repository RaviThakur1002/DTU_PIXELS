            ...
            <div className="p-4">
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  ...
                  className="p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                >
              ...
              <nav className="space-y-1">
                ...
                {isAdmin && (
                  <>
                    ...
                    <button
                      className="flex items-center gap-2 px-4 py-2 text-md font-medium text-gray-700 hover:bg-gray-100 hover:text-blue-600 transition-colors duration-300 w-full text-left"
                      onClick={() => {
                        setIsPromotionPopupOpen(true);
                        toggleSidebar();
                      }}
