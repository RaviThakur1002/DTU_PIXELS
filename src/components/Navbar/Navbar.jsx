    ...
    <div className="sticky z-50 top-0 w-full bg-white shadow-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
                ...
                <div className="absolute z-50 right-0 mt-2 w-48 bg-white rounded-md shadow-xl py-1">
                  ...
                  {isAdmin && (
                    <>
                      <CreateContest />
                      <button
                        className="flex border-none outline-none items-center gap-3 px-4 py-3 text-md font-medium text-gray-700 hover:bg-blue-50 hover:text-blue-600 rounded-md transition-all duration-200 w-full text-left"
                        onClick={() => {
                  ...
                  <button
                    ...
                    className="w-full mt-2 px-3 py-2 text-sm font-medium text-gray-700 border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-300"
                  >
        ...
        <div
          style={sidebarStyle}
          ref={sidebarRef}
          className="lg:hidden p-5 flex flex-col"
        >
          <div className="flex items-center justify-between mb-6">
            <div className="inline-flex items-center space-x-2">
              ...
              <span className="font-bold text-lg">DTU PIXELS</span>
            </div>
            <button
          ...
          {user && (
            <div className="mb-6 p-4 bg-gray-50 rounded-lg shadow-sm">
              <img
                className="rounded-full w-20 h-20 mb-3 mx-auto border-2 border-blue-500"
                src={user.photoURL}
                alt="User profile"
              />
              ...
              {isAdmin && (
                <span className="block text-sm font-semibold text-blue-600 text-center mb-2">
                  Admin
                </span>
              )}
              <CopyUID />
          ...
          <nav className="space-y-1 mb-6">
            {menuItems.map((item) => (
              <NavLink
                key={item.name}
                to={item.href}
                className="flex items-center gap-3 px-4 py-3 text-md font-medium text-gray-700 hover:bg-blue-50 hover:text-blue-600 rounded-md transition-all duration-200"
                onClick={toggleSidebar}
              >
                <ChevronRight className="h-5 w-5" />
                <span>{item.name}</span>
            ...
            {isAdmin && (
              <>
                <CreateContest className="flex items-center gap-3 px-4 py-3 text-md font-medium text-gray-700 hover:bg-blue-50 hover:text-blue-600 rounded-md transition-all duration-200 w-full text-left" />
                <button
                  className="flex outline-none items-center gap-3 px-4 py-3 text-md font-medium text-gray-700 hover:bg-blue-50 hover:text-blue-600 rounded-md transition-all duration-200 w-full text-left"
                  onClick={() => {
                    setIsPromotionPopupOpen(true);
                    toggleSidebar();
                  }}
          ...
          <div className="mt-auto">
            {user ? (
              <button
                ...
                className="w-full px-4 py-3 text-sm font-medium text-white bg-blue-600 rounded-md shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200"
              >
                <div className="flex items-center justify-center gap-2">
                  <svg
                    className="h-5 w-5"
              ...
              <button
                className="w-full flex items-center justify-center px-4 py-3 bg-white text-blue-600 border border-blue-300 rounded-md shadow-sm hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200"
                onClick={() => {
