          ...
          <nav className="space-y-1 mb-6">
            ...
            {isAdmin && (
              <>
                ...
                <button
                  className="flex items-center gap-3 px-4 py-3 text-md font-medium text-gray-700 hover:bg-blue-50 hover:text-blue-600 rounded-md transition-all duration-200 w-full text-left"
                  onClick={() => {
                    setIsPromotionPopupOpen(true);
                    toggleSidebar();
                  }}
