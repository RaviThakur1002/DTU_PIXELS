...
const Info = () => {
  ...
  const cardVariants = {
    ...
    return (
    <div className="bg-[#171717] text-white py-16 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <motion.span 
            className="bg-[#2c2c2e] text-sm font-semibold px-3 py-1 rounded-full uppercase tracking-wide text-[#5b3dcc]"
        ...
        >
          <ServiceCard 
            icon={<FaCameraRetro className="w-12 h-12 text-[#5b3dcc]" />}
          ...
          />
          <ServiceCard 
            icon={<FaUsers className="w-12 h-12 text-[#5b3dcc]" />}
          ...
          />
          <ServiceCard 
            icon={<FaGraduationCap className="w-12 h-12 text-[#5b3dcc]" />}
