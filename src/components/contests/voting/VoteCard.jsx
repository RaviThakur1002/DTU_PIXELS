      ...
      >
        ...
        >
          <div className="relative h-full w-full rounded-lg overflow-hidden shadow-lg">
            ...
            <motion.button
              className="absolute bottom-4 right-4 p-2 bg-gray-500 text-white rounded-full shadow-lg flex items-center justify-center"
              onClick={handleFlip}
        ...
        <motion.div 
          ...
          whileHover={{ boxShadow: "0 10px 20px rgba(0,0,0,0.2)" }}
        >
          <div className="relative h-full w-full rounded-lg overflow-hidden shadow-lg bg-gradient-to-br from-blue-100 to-purple-500 flex flex-col justify-center items-center p-6">
            <div className="text-center mb-4">
              <svg
                className="w-8 h-8 text-black mb-4 mx-auto"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
                <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" />
              </svg>
              <p className="text-black font-semibold italic text-lg">{entry.quote}</p>
            </div>
            <motion.button
